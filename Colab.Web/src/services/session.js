define([], function()
{
    ...
    Session.prototype.setItem = function(key, value, callback)
    {
    ...
    Session.prototype.removeItem = function(key, callback)
    {
    ...
    Session.prototype.getAll = function(callback)
    {
    ...
    Session.prototype.setAll = function(data, callback)
    {
